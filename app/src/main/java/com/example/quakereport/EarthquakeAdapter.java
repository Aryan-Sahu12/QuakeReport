...
public class EarthquakeAdapter extends ArrayAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        String output = formatMagnitude(CurrentData.getMagnitude());
        ...
        if(location.contains("of")){
            ...
            locationOffset.setText(location.substring(0,i+2));
            primarylocation.setText(location.substring(i+2 , location.length()));
        }
        else{
